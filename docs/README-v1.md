...
|   speed   | Int      | 否       | 语速 0.75-1.25 可以不设置,默认是 1.0                         |
|  volume   | Float    | 否       | 音量 0.75-1.25 可以不设置,默认是 1.0                         |
|  content  | String   | 是       | UTF8 编码的文本内容                                          |
